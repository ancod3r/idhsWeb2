...
import { Container, Typography, Box, Grid, TextField, Button, Link, Paper, useTheme, IconButton } from '@mui/material';
...
const Contact = () => {
  ...
  const [success, setSuccess] = useState("");  // State for successful Register message
      ...
      <Grid container spacing={2} sx={{ mb: 2 }}>
        <Grid item xs={12} md={7}>
          <Paper elevation={5} sx={{ p: 4 }}>
            <Box component="form" onSubmit={handleSubmit} autoComplete="off" ref={form}>
