...
const HospitalDetails = () => {
    ...
    const doctorCardData = Array.from({ length: 9 }, (_, index) => ({
        id: index + 1,
        image: `/hospital.jpg`,
        name: `Med Oplus Heart Center East Delhi`,
    ...
    return (
        ...
        <Box
            sx={{
                ...
                <Link to="/" style={{ textDecoration: 'none', color: '#fff' }}>Top Hospitals</Link>
                <Typography color='#fff'>{'>'}</Typography>
                <Typography sx={{ color: '#fff' }}>{id}</Typography>
        </Box>
        </Grid>
        </Box>
        <Box
                ...
                <Box
                    sx={{
                        ...
                        marginTop: { xs: '0', md: '0' },
                                ...
                                <Typography variant="body1" sx={{ color: '#fff', fontWeight: 'bold' }}>Multi Speciality</Typography>
                                ...
                                <Typography variant="body1" mb={2} sx={{ marginLeft: '20px', marginTop: '-10px', color: '#262626' }}>Distance 5KM</Typography>
                                ...
                                <Box mb={2} display="flex" alignItems="center" justifyContent="flex-start">
                                    <Box display="flex" flexDirection="column" alignItems="flex-start" justifyContent="center">
                                        <Typography variant="body1" sx={{ color: '#fff' }}>Established on</Typography>
                                        <Typography variant="body1" fontWeight={600} sx={{ color: '#fff' }}>2014</Typography>
                                    </Box>
                                    <Divider orientation="vertical" flexItem sx={{ borderLeft: '1px solid #fff', mx: 5 }} />
                                    <Box gutterBottom marginLeft={{ xs: 3, md: 0 }} display="flex" flexDirection="column" alignItems="center" justifyContent="center">
                                ...
                                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: { xs: 'center', md: 'flex-start'}, gap: '10px', flexDirection: { xs: 'column', md: 'row'} }}>
                                    <Button
                                        variant="contained"
                                        color="primary"
                                        sx={{
                        ...
                        >
                            <Typography variant="h3" sx={{ fontWeight: 'bold', fontFamily: 'PoppinsBold' }}>Specialities In Hospital</Typography>
