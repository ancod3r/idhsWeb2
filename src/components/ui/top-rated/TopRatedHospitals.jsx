...
const TopRatedHospitals = () => {
  const [showAllTopRatedHospitals, setShowAllTopRatedHospitals] = useState(false);
  const scrollContainerRef = useRef(null);

  const images = [
    { src: '/doctor1.jpg', title: 'Ambedakar Hospital', speciality: 'Multispeciality' },
    { src: '/doctor2.jpg', title: 'Nitya Hospital', speciality: 'Multispeciality' },
    { src: '/doctor6.jpg', title: 'Birla Hospital', speciality: 'Multispeciality' },
    { src: '/doctor3.jpg', title: 'Birla Hospital', speciality: 'New Delhi, India' },
    { src: '/doctor4.jpg', title: 'Birla Hospital', speciality: 'Multispeciality, Gurgaon, India' },
    { src: '/doctor5.jpg', title: 'Birla Hospital', speciality: 'Multispeciality, Gurgaon, India' },
    { src: 'https://via.placeholder.com/100', title: 'Raina Hospital', speciality: 'Multispeciality' },
  ];
        ...
        //   backgroundColor: '#F9FBFC',
          ...
          <Grid item xs={12} sm={12} md={12} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'left', alignItems: 'flex-start' }}>
            <Typography variant="h1" gutterBottom sx={{ fontSize: { xs: '1.25rem', sm: '1.5rem' }, textAlign: 'left' }}>
              ...
              <span style={{ color: '#527C88', fontFamily: 'PoppinsBold' }}>Hospitals</span>{' '}
          ...
          <Box mt={4} sx={{ width: '100%', textAlign: 'right' }}>
            <Button
              ...
              {showAllTopRatedHospitals ? 'Show Less' : 'View All'}
            </Button>
          </Box>
        </Grid>
      </Box>
...
export default TopRatedHospitals;
